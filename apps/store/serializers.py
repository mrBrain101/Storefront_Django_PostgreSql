...
class ProductSerializer(serializers.ModelSerializer):
    ...
    price_with_tax = (serializers
                      .SerializerMethodField(method_name='calculate_tax'))
...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    total_price = (serializers
                   .SerializerMethodField(method_name='get_total_price'))
...
class OrderItemSerializer(serializers.ModelSerializer):
    unit_price = serializers.DecimalField(read_only=True, max_digits=6, 
                                          decimal_places=2)
