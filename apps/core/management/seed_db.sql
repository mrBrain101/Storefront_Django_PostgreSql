-- Populate collections and products and reset PG Auto Increment
...
ON CONFLICT (id) DO NOTHING;
SELECT setval(pg_get_serial_sequence('store_collection', 'id'), coalesce(max(id), 0) + 1, false) FROM store_collection;
SELECT setval(pg_get_serial_sequence('store_product', 'id'), coalesce(max(id), 0) + 1, false) FROM store_product;
SELECT setval(pg_get_serial_sequence('store_product_promotions', 'id'), coalesce(max(id), 0) + 1, false) FROM store_product_promotions;
SELECT setval(pg_get_serial_sequence('store_promotion', 'id'), coalesce(max(id), 0) + 1, false) FROM store_promotion;
SELECT setval(pg_get_serial_sequence('tags_tag', 'id'), coalesce(max(id), 0) + 1, false) FROM tags_tag;
SELECT setval(pg_get_serial_sequence('tags_taggeditem', 'id'), coalesce(max(id), 0) + 1, false) FROM tags_taggeditem;